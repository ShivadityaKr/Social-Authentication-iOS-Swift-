...
class FacebookAuthManager: NSObject {
    static func loginWithFacebookId(view: UIViewController, completion: @escaping (_ error: Error?,_ _credential: String?,_ _result: [String: Any]?) -> Void) {
    ...
    static func getFBUserData(credential: String, completion: @escaping ([String: Any]) -> Void) {
        ...
        let graphRequest = FBSDKLoginKit.GraphRequest(graphPath: "me",
                                                      parameters: ["fields": "first_name, last_name, email,  age_range, gender, picture.width(300).height(300)"],
